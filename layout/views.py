...
class ButterListView(TemplateView):
    """View that fetches page types"""
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        # fetch page_data
        page_data = self.get_pages(page_type=self.kwargs['page_type'], params=params)
        context['page_data'] = page_data
        return context
    ...
    def get_pages(self, page_type='*', params={}):
        """Fetch a page from butter"""
        page_data = Butter.pages.all(page_type=page_type, params=params)['data']
        return page_data